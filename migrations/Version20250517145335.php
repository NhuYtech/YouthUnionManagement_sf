 ...
 */
final class Version20250517145335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recognition CHANGE file_decision file_decision VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recognition CHANGE file_decision file_decision VARCHAR(255) NOT NULL');
    }
}
