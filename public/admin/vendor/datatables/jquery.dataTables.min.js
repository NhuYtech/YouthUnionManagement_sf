...
$(document).ready(function () {
  // Kiểm tra nếu DataTable đã khởi tạo thì hủy trước khi tạo mới
  ...
  // Kiểm tra nếu phần tử chưa được di chuyển thì mới di chuyển
  if ($(".top-container").length === 0) {
    // Gộp "Hiển thị X dòng" và "Tìm kiếm" vào một div
    $(".dataTables_length, .dataTables_filter").wrapAll(
      '<div class="top-container"></div>'
    );

    // Đưa phần này ra ngoài table-responsive
    $(".top-container").insertBefore(".table-responsive");
  ...
  if ($(".bottom-container").length === 0) {
    // Gộp "Hiển thị X đến Y" và phân trang vào một div
    $(".dataTables_info, .dataTables_paginate").wrapAll(
      '<div class="bottom-container"></div>'
    );

    // Đưa phần này ra ngoài table-responsive
    $(".bottom-container").insertAfter(".table-responsive");
